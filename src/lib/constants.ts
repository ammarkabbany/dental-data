...
export const APPWRITE_PROJECT = process.env.NEXT_PUBLIC_APPWRITE_PROJECT_ID as string;
...
export const CASE_INVOICES_COLLECTION_ID = process.env.NEXT_PUBLIC_CASE_INVOICES_COLLECTION_ID as string
...
export const DOCTORS_FUNCTION_ID = process.env.NEXT_DOCTORS_FUNCTION_ID as string
