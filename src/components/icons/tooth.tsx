export function ToothIcon({ className, w = 6, h = 6 }: { className: string, h: number, w: number }) {
	return (
		<svg
			version="1.0"
			...
			className={`w-${w} h-${h} text-gray-400 peer-checked:text-blue-500 transition-colors duration-300`}
		>
			<g transform="translate(0.000000,125.000000) scale(0.115000,-0.100000)">
				<path
					className={className}
